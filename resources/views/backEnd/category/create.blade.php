        ...
        <div class="row-fluid">
            ...
            <div class="widget-box">
                <div class="widget-title"> <span class="icon"> <i class="icon-info-sign"></i> </span>
                    <h5>Yeni kateqoriya əlavə edin</h5>
                </div>
                <div class="widget-content nopadding">
                    <form class="form-horizontal" method="post" action="{{route('category.store')}}" name="basic_validate" id="basic_validate" novalidate="novalidate">
                        ...
                        <div class="control-group{{$errors->has('name')?' has-error':''}}">
                            <label class="control-label">Kateqoriya Adı :</label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <label class="control-label">Kateqoriya Etiketi :</label>
                        ...
                        <div class="control-group">
                            <label class="control-label">Təsvir :</label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="submit" value="Əlavə edin" class="btn btn-success">
                            </div>
                        </div>
                    </form>
                </div>
